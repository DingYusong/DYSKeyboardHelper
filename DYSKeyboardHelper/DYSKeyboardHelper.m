...
@interface DYSKeyboardHelper ()
{
    CGRect keyboardBounds;
    
    DYSKeyboardAccessoryView *view_keyboardToolbar;
...
@implementation DYSKeyboardHelper
...
- (void)addAccessaryBarToKeyboard {
    ...
    view_keyboardToolbar = [[DYSKeyboardAccessoryView alloc] initWithFrame:CGRectMake(0, 0, view_targetObject.frame.size.width, keyBoardToolbarHeight)];
