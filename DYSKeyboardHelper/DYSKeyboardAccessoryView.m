...
@interface DYSKeyboardAccessoryView ()
{
    UIToolbar *toolbar_Keyboard;
}
@end

@implementation DYSKeyboardAccessoryView
...
@implementation DYSKeyboardAccessoryView (UIKeyboardViewAction)
